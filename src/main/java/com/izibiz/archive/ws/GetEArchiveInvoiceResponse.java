...
/**
 * <p>Java class for GetEArchiveInvoiceResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetEArchiveInvoiceResponse"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="INVOICE" type="{http://www.w3.org/2005/05/xmlmime}base64Binary" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "GetEArchiveInvoiceResponse", propOrder = {
    "invoice",
    "requestreturn",
    "errortype"
})
public class GetEArchiveInvoiceResponse {

    @XmlElement(name = "INVOICE")
    protected List<Base64Binary> invoice;
     ...
     * 
     */
    public List<Base64Binary> getINVOICE() {
        if (invoice == null) {
            invoice = new ArrayList<Base64Binary>();
        }
        return this.invoice;
    }
