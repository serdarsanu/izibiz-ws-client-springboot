...
/**
 * <p>Java class for GetEArchiveInvoiceStatusResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetEArchiveInvoiceStatusResponse"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="INVOICE" type="{http://schemas.i2i.com/ei/wsdl/archive}EARCHIVE_INVOICE" maxOccurs="500" minOccurs="0"/&gt;
...
@XmlType(name = "GetEArchiveInvoiceStatusResponse", propOrder = {
    "invoice",
    "requestreturn",
    "errortype"
})
public class GetEArchiveInvoiceStatusResponse {
    ...
    protected List<EARCHIVEINVOICE> invoice;
     ...
     * {@link EARCHIVEINVOICE }
     * 
     * 
     */
    public List<EARCHIVEINVOICE> getINVOICE() {
        if (invoice == null) {
            invoice = new ArrayList<EARCHIVEINVOICE>();
        }
        return this.invoice;
    }
