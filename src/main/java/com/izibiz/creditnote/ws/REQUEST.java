...
@XmlSeeAlso({
    LoadCreditNoteRequest.class,
    SendCreditNoteRequest.class,
    GetCreditNoteStatusRequest.class,
    CancelCreditNoteRequest.class,
    GetCreditNoteRequest.class,
    GetCreditNoteReportRequest.class,
    MarkCreditNoteRequest.class
})
