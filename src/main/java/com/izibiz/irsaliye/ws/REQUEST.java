...
@XmlSeeAlso({
    GetDespatchAdviceRequest.class,
    GetDespatchAdviceStatusRequest.class,
    GetReceiptAdviceRequest.class,
    GetReceiptAdviceStatusRequest.class,
    LoadDespatchAdviceRequest.class,
    LoadReceiptAdviceRequest.class,
    MarkDespatchAdviceRequest.class,
    MarkReceiptAdviceRequest.class,
    SendDespatchAdviceRequest.class,
    SendReceiptAdviceRequest.class,
    UserRequest.class
})
