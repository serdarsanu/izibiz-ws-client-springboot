...
@XmlSeeAlso({
    ...
    MarkInvoiceRequest.class,
    PrepareInvoiceResponseRequest.class,
    SendInvoiceResponseRequest.class,
    SendInvoiceResponseWithServerSignRequest.class,
    GetUserListRequest.class,
    GetUserListBinaryRequest.class,
    CheckUserRequest.class,
    GetInvoiceStatusRequest.class,
    GetInvoiceStatusAllRequest.class,
    CancelDraftInvoiceRequest.class,
    LoadInvoiceRequest.class,
    GetEnvelopeRequest.class,
    MarkEnvelopeRequest.class,
    GetEnvelopeStatusRequest.class,
    GetInvoiceWithTypeRequest.class,
    GetInvoiceCountRequest.class
})
